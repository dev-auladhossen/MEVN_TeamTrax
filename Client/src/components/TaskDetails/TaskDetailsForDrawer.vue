      ...
      <div class="w-full space-y-3">
        <div class="w-full flex justify-between gap-8">
          <div class="w-full flex gap-1">
            <h1 class="text-lg font-bold text-gray-800 w-full">
          ...
          <div class="flex gap-1 items-start">
            ...
            <button
              ...
              @click="handleDelete"
            >
              <font-awesome-icon class="text-white font-xl" icon="trash-can" />
            </button>
          </div>
        </div>
        <!-- Description  -->
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex gap-1 items-center">
            <span class="text-sm text-gray-600 font-bold">Parent Project:</span>
...
const emit = defineEmits(["taskEdited", "taskDeleted"]);
...
const currentTaskId = props.task._id;
...
const deleteAttachment = async (filename) => {
  try {
    await axios.delete(
      `http://localhost:5000/api/task/${currentTaskId}/attachment/${filename}`
    );
